...
// Mise à jour des métriques via WebSocket
function updateMetricsFromSocket(data) {
...
// Mise à jour de l'indicateur de connexion WebSocket
function updateConnectionStatus(connected) {
    ...
    if (connected) {
        ...
        statusBadge.innerHTML = '<i class="bi bi-circle-fill"></i> Connecté';
        wsIndicator.className = 'badge bg-success me-3';
        wsIndicator.innerHTML = '<i class="bi bi-broadcast"></i> WebSocket Actif';
    } else {
        statusBadge.className = 'badge bg-danger';
        statusBadge.innerHTML = '<i class="bi bi-x-circle-fill"></i> Déconnecté';
        wsIndicator.className = 'badge bg-danger me-3';
        wsIndicator.innerHTML = '<i class="bi bi-broadcast-pin"></i> WebSocket Inactif';
    }
}
...
function initWebSocket() {
    ...
    socket.on('metrics_update', function(data) {
        console.log('Métriques reçues via WebSocket');
